...
namespace KilometroZero7.Views
{
    public class ComunisController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "comune_Id,nome_comune,provincia,regione,data_registrazione,attivo,ultimo_accesso")] Comuni comuni)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "comune_Id,nome_comune,provincia,regione,data_registrazione,attivo,ultimo_accesso")] Comuni comuni)
        {
            if (ModelState.IsValid)
            {
